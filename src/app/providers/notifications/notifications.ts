...
export class Notifications {
  ...
  constructor(private apiService: ApiService) {
    ...
    for (const feedback of feedbacks) {
      this.feedbacks.push(new Notification(feedback));
    }
    this.recordRetrieve();
  }
  ...
  async recordUpdate(feedback: Notification, payload): Promise<ApiResponse> {
  ...
  async recordDelete(feedback: Notification): Promise<ApiResponse> {
